...
function formatCost(cost: number, tokens: number = 0): string {
  // Distinguish between "free/zero cost" and "pricing unavailable"
  if (cost === 0 && tokens > 0) {
    return "—"; // Pricing unavailable (has tokens but no cost)
  }
...
function formatModelName(modelId: string): string {
  // Shorten model IDs like "google/gemini-2.5-pro" → "gemini-2.5-pro"
